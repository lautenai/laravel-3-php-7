    ...
    <div class="box-body">
		...
		{{ Form::hidden('csrf_token', Session::token())}}
			<div class="form-group">
				...
				{{ Form::select('user_id', $user, $comment->user_id, array('id' => 'user_id', 'class' => 'form-control', 'placeholder' => 'User Id', 'required' => 'required')) }}
			</div>
			<div class="form-group">
				{{Form::label('blog_post_id', 'Blog Post Id')}}
				{{ Form::select('blog_post_id', $blog_post, $comment->blog_post_id, array('id' => 'blog_post_id', 'class' => 'form-control', 'placeholder' => 'Blog Post Id', 'required' => 'required')) }}
			</div>
			<div class="form-group">
				{{Form::label('content', 'Content')}}
				
				{{Form::textarea('content', Input::old('content', $comment->content), array('class' => 'form-control', 'placeholder' => 'Content', 'required' => 'required'))}}
			</div>
			</div>

    ...
    <div class="box-body no-padding">
	    <div class="box box-primary">
	      {{Form::open(null, 'post', array('role' => 'form'))}}
	        ...
	        <a href="{{URL::to('users/edit/'.$user->id)}}" class="btn btn-primary">Edit</a>
	        <a href="{{URL::to('users/delete/'.$user->id)}}" class="btn btn-danger" onclick="return confirm('Are you sure?')">Delete</a>

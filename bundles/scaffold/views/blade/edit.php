...
<?php if(in_array($type, array('string', 'integer', 'float', 'date', 'timestamp'))): ?>
				{{Form::text('<?php echo $field; ?>', Input::old('<?php echo $field; ?>', $<?php echo $singular; ?>-><?php echo $field; ?>), array('class' => 'form-control', 'placeholder' => '<?php echo ucwords(str_replace('_', ' ', $field)); ?>', 'required' => 'required'))}}
...
<?php elseif($type == 'text' || $type == 'blob'): ?>
				{{Form::textarea('<?php echo $field; ?>', Input::old('<?php echo $field; ?>', $<?php echo $singular; ?>-><?php echo $field; ?>), array('class' => 'form-control', 'placeholder' => '<?php echo ucwords(str_replace('_', ' ', $field)); ?>', 'required' => 'required'))}}
<?php endif; ?>
<?php endif; ?>
			</div>
<?php endforeach; ?>

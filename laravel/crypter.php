...
class Crypter {
	...
	public static function encrypt($value)
	{
		...
		$ciphertext_raw = openssl_encrypt($value, $cipher, static::key(), $options=OPENSSL_RAW_DATA, $iv);
		$hmac = hash_hmac('sha256', $ciphertext_raw, static::key(), $as_binary=true);
	...
	public static function decrypt($value)
	{
		...
		$decrypted = openssl_decrypt($ciphertext_raw, $cipher, static::key(), $options=OPENSSL_RAW_DATA, $iv);
